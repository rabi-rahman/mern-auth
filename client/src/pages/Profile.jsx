...
export default function Profile() {
  ...
  return (
    ...
    <form className="flex flex-col gap-4">
      <img src={currentUser.profilepicture} alt="Profile" className="h-24 w-24 cursor-pointer rounded-full object-cover mt-2 self-center" />
      ...
      <input defaultValue={currentUser.pass} type="password" id="password" placeholder="Password" className="bg-slate-100 rounded-lg p-3" /> 
